#じゃんけんで負けた後、あっち向いてホイで負けたのに勝ちになる。==>if lose_my_select_finger == win_cpu_select_finger
#puts "相手が勝ちました。" に変更しました。
#program_handが3になってしまって、勝負が終了してしまう。==>  program_hand = rand(0..2)に変更しました。
#インデントがずれてしまっていて読みにくい部分がある。==>同じ処理の場所を行を揃えてきれいにしました。
#３点を修正しました。レビューお願いします。
